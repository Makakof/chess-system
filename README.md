...
## General Objective:
Apply the knowledge gained so far in the OOP course
...
#### Checklist:
Since we haven't seen the graphic interface yet, we'll use the coordinate system (letter, number) and a matrix as shown below to implement the game.
